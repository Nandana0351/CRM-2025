...
class StudentListView(View):
    ...
    def get(self,request,*args,**kwargs):
        ...
        data = {'title' : 'Students','students':students,
                ...
                'trainer_choices':Trainer.objects.all(),'query':query,
    ...
    def post(self,request,*args,**kwargs):
        ...
        if form.is_valid():
            ...
            with transaction.atomic():
             ...
             context = {'user':student.email,'password':password,'name':f'{student.first_name} {student.last_name}'}
        ...
        #                                 adm_num=adm_num,
        #                                 contact_num=contact_num,photo=photo,
        #                                 dob=dob,education=education,address=address,place=place,
